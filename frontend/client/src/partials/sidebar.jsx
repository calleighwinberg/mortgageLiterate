  ...
  return (
    <div className="bg-dark min-vh-100 d-flex flex-column p-3 text-light" style={{ width: '200px' }}>
      ...
      <Nav className="flex-column" variant="pills">
        <Nav.Link href={`/tcas/${tca._id}/edit`} className="text-light">
        ...
        <Collapse in={openP1}>
          <div id="p1-collapse">
            <Nav className="flex-column ms-3">
              <Button variant="link" className="text-light text-start w-100">
                Closing Costs
              </Button>
              <Button variant="link" className="text-light text-start w-100">
                Monthly Costs
        ...
        {/* Presentation View */}
        <Nav.Link href={`/tcas/${tca._id}`} className="text-light">
